...
// Bắt đầu đăng ký -> tạo PendingUser + gửi OTP
...
// Xác thực OTP -> tạo User + đăng nhập
router.post("/register-verify", async (req, res) => {
  try {
    ...
    // Chống brute-force: tối đa 5 lần
...
// Gửi lại OTP (nếu vẫn còn pending)
...
/**
 * ==============
 *  LOGIN / REFRESH / LOGOUT / ME (giữ nguyên)
 * ==============
 */
